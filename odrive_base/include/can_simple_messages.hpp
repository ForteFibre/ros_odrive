...
struct Get_Version_msg_t final
{
  ...
  void encode_msg(TBoard::TCanIntf::TMsg & msg) { encode_buf(can_msg_get_payload(msg).data()); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Encoder_Estimates_msg_t(const TBoard::TCanIntf::TMsg & msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Controller_Mode_msg_t(const TBoard::TCanIntf::TMsg & msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Traj_Vel_Limit_msg_t(const TBoard::TCanIntf::TMsg & msg) { decode_msg(msg); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Traj_Accel_Limits_msg_t(const TBoard::TCanIntf::TMsg & msg) { decode_msg(msg); }
...
struct Reboot_msg_t final
{
  ...
  void encode_buf(uint8_t * buf) const { can_set_signal_raw<uint8_t>(buf, Action, 0, 8, true); }

  void decode_buf(const uint8_t * buf) { Action = can_get_signal_raw<uint8_t>(buf, 0, 8, true); }
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Get_Bus_Voltage_Current_msg_t(const TBoard::TCanIntf::TMsg & msg) { decode_msg(msg); }
...
struct Clear_Errors_msg_t final
{
  ...
  void encode_buf(uint8_t * buf) const { can_set_signal_raw<uint8_t>(buf, Identify, 0, 8, true); }

  void decode_buf(const uint8_t * buf) { Identify = can_get_signal_raw<uint8_t>(buf, 0, 8, true); }
...
struct Set_Absolute_Position_msg_t final
{
...
#ifdef ODRIVE_CAN_MSG_TYPE
  Set_Absolute_Position_msg_t(const TBoard::TCanIntf::TMsg & msg) { decode_msg(msg); }
  ...
  void encode_buf(uint8_t * buf) const { can_set_signal_raw<float>(buf, Position, 0, 32, true); }

  void decode_buf(const uint8_t * buf) { Position = can_get_signal_raw<float>(buf, 0, 32, true); }
...
struct Set_Pos_Gain_msg_t final
{
  ...
  void encode_buf(uint8_t * buf) const { can_set_signal_raw<float>(buf, Pos_Gain, 0, 32, true); }

  void decode_buf(const uint8_t * buf) { Pos_Gain = can_get_signal_raw<float>(buf, 0, 32, true); }
